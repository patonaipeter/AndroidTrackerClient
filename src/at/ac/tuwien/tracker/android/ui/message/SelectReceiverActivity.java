package at.ac.tuwien.tracker.android.ui.message;
...
public class SelectReceiverActivity extends AbstractAsyncListActivity {
	...
	public void onStart()
	{
		...
		final TextView message = (TextView) findViewById(R.id.editText_text);
		
		button.setOnClickListener(new OnClickListener() {
			
			public void onClick(View v) {
				new SendMessageTask(adapter.getSelectedUsers(), message.getText().toString()).execute();
	...
	private void showRace(String result, ArrayList<UserDTO> selectedUsers) {
		...
		Toast toast = Toast.makeText(getBaseContext(), "Message Sent", Toast.LENGTH_SHORT);
        toast.show();
        //TODO reset view
        
        
        
		Intent intent = new Intent(this.getApplicationContext(),SocialActivity.class);
//		
	...
	{	
		...
		public SendMessageTask(ArrayList<UserDTO> selectedUsers, String string) {
		...
		protected String doInBackground(Void... params) 
		{
			try 
			{
				...
				final String url = getString(R.string.base_uri) + Constants.sendmessage;
				...
				requestData.add("msgText", msgText);
				String useridstring = "";
