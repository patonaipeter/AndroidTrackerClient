...
import at.ac.tuwien.tracker.android.serverConnection.adapters.NotificationAdapter;
...
public class ShowNotificationsActivity extends AbstractAsyncListActivity {
	...
	{	
		...
		NotificationAdapter adapter = new NotificationAdapter(this, msgs);
    ...
    // Private classes
    //***************************************
	private class ListNotifications extends AsyncTask<Void, Void, List<MsgDTO>> 
	{	
		@Override
		...
		protected List<MsgDTO> doInBackground(Void... params) 
		{
			try 
			{
				...
				final String url = getString(R.string.base_uri) + Constants.listmessages;
