...
public class BrowseFriendAdapter extends BaseAdapter {
	...
	public BrowseFriendAdapter(Context context, List<UserDTO> users) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		view.setOnClickListener(new View.OnClickListener()
        {
            ...
            {                   
            	...
            	Intent intent = new Intent(context,RaceMap.class);

            	intent.putExtra("userid", user.getId());
    			intent.putExtra("raceid", getRaceId());
